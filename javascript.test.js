...
function calculateClockAngle(hours, minutes) {
  let minuteAngle = minutes * 6; // Stokes - Could be written as (minutes / 60) * 360 but it's been simplified.
  let hourAngle = hours * 30 + minutes / 2; // Stokes - Could be written (hours / 12) * 360 + (minutes / 60) * 30 but it's been simplified.
